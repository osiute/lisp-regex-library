;; Изолирует логику работы с фиксированным вектором start-states (128 состояний, 
;; где индекс — битовая маска контекста, записанная в правых 6-ти (0-5) разрядах, а также тип автомат: anchored или unanchored, — записанный в 6-ом разряде) объекта dfa.
